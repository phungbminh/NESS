...
class GraphLoader:
    ...
    def get_dataset(self, dataset_name: str, file_path: str) -> Tuple[Data, Data, Data]:
        ...
        train_data = self.generate_clustering_subgraphs(train_data)

        # Return
        return train_data, val_data, test_data

    def generate_clustering_subgraphs(self, train_data: Data, n_clusters: int = 8) -> List[Data]:
        """
        Generates subgraphs using spectral clustering.
        ...
        -------
        List[Data]
            List of subgraphs based on spectral clustering.
        """
        import torch
        import numpy as np
    ...
    def generate_louvain_subgraphs(self, train_data: Data) -> List[Data]:
        """
        Generates subgraphs using Louvain community detection.
        ...
        -------
        List[Data]
            List of subgraphs generated by community detection.
        """
        import networkx as nx
        from torch_geometric.utils import to_networkx, from_networkx
    ...
    def generate_metis_subgraphs(self, train_data: Data, n_parts: int = 8) -> List[Data]:
        """
        Generates subgraphs using METIS graph partitioning.
        ...
        for i in range(n_parts):
            ...
            # Copy node features if available
            if hasattr(train_data, 'x') and train_data.x is not None:
                node_mapper = {old_idx: new_idx for new_idx, old_idx in enumerate(nodes)}
                subgraph_data.x = train_data.x[nodes]
